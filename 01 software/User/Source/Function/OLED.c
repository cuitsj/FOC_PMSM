...
#define OLED_SCL(x)   {GP07=x;}
#define OLED_SDA(x)   {GP05=x;}
#define OLED_RST(x)   {GP04=x;}
#define OLED_DC(x)    {GP03=x;}
#define OLED_CS(x)    {GP02=x;}
...
//    gpio_init (OLED_DC_PIN , GPO,1);
	...
	SetBit(P0_OE, P02, 1);	// config P11 as output,0 as input,1 as output
	SetBit(P0_PU, P02, 1);  // enable P01 pull up,0 as disable,1 as enable	
	GP02 = 1;
	
	SetBit(P0_OE, P03, 1);	// config P11 as output,0 as input,1 as output
	SetBit(P0_PU, P03, 1);  // enable P01 pull up,0 as disable,1 as enable	
	GP03 = 1;
	
	SetBit(P0_OE, P04, 1);	// config P11 as output,0 as input,1 as output
	SetBit(P0_PU, P04, 1);  // enable P01 pull up,0 as disable,1 as enable	
	GP04 = 1;
	
	SetBit(P0_OE, P05, 1);	// config P11 as output,0 as input,1 as output
	SetBit(P0_PU, P05, 1);  // enable P01 pull up,0 as disable,1 as enable	
	GP05 = 0;
	
	SetBit(P0_OE, P07, 1);	// config P11 as output,0 as input,1 as output
	SetBit(P0_PU, P07, 1);  // enable P01 pull up,0 as disable,1 as enable	
	GP07 = 1;
